...
DROP POLICY IF EXISTS "residential_complexes_insert_policy" ON residential_complexes;
DROP POLICY IF EXISTS "residential_complexes_update_policy" ON residential_complexes;
DROP POLICY IF EXISTS "residential_complexes_delete_policy" ON residential_complexes;
